// Ported verbatim from pg_query_go v6.2.2 makefuncs.go (BSD-3, see
// LICENSE.LIBPG_QUERY); only the package clause differs. These constructors
// are already pure Go upstream.
package oliphant
