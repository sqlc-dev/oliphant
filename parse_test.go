// Ported from pg_query_go v6.2.2 parse_test.go (BSD-3, see LICENSE.LIBPG_QUERY).
// The expected-tree literals are UNCHANGED — compiling them against oliphant's
// types is milestone 1's acceptance gate. Only the import paths differ, plus a
// skipUnlessImplemented guard until the parser milestones land.
